...
handle_post(Req, State) ->
    ...
    #{<<"sender_id">>:=PlayerID, <<"content">>:=Content} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({post_circle, {PlayerID, Content}}),
