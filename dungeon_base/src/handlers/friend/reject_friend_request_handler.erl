-module(reject_friend_request_handler).
...
handle_post(Req, State) ->
    ...
    #{<<"request_id">>:=RequestID, <<"receiver_id">>:=ReceiverID} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({reject_friend_request, {RequestID, ReceiverID}}),
