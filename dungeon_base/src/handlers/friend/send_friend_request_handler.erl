-module(send_friend_request_handler).
...
handle_post(Req, State) ->
    ...
    #{<<"sender_id">>:=SenderID, <<"receiver_id">>:=ReceiverID} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({send_friend_request, {SenderID, ReceiverID}}),
