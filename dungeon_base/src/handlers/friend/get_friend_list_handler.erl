-module(get_friend_list_handler).
...
handle_post(Req, State) ->
    ...
    #{<<"player_id">>:=PlayerID, <<"offset">>:=Offset} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({get_friend_list, {PlayerID, Offset}}),
