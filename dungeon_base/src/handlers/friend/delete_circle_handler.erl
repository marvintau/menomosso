...
handle_post(Req, State) ->
    ...
    #{<<"sender_id">>:=PlayerID, <<"circle_id">>:=CircleID} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({delete_circle, {CircleID, PlayerID}}),
