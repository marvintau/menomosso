...
handle_post(Req, State) ->
    ...
    #{<<"player_id">>:=PlayerID, <<"receiver_id">>:=ReceiverID, <<"mail_id">>:=MailID, <<"content">>:=Content} = jiffy:decode(ReqBody, [return_maps]),
    
    Message = dungeon_base_sup:query({reply_mail, {PlayerID, ReceiverID, MailID, Content}}),
