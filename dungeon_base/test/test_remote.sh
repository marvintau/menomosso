...
do
    ...
    curl -H "Content-Type: application/json" -X POST\
        ...
        "skills":["fortify_armor", "double_attack", "triple_attack", "single_attack", "single_attack", "single_attack", "single_attack", "single_attack", "single_attack", "single_attack"]}' http://everstream.cn:1337/api/battle_request
done
